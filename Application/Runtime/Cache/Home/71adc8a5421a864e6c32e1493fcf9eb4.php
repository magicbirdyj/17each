...
<link rel="stylesheet" type="text/css" href="/Public/Home/Css/order_tuikuang.css">
...
<script  type="text/javascript">
    ...
    <div class="view">
        <div class="tuikuang_div">
            <?php if($order['pay_status'] == '1'): ?><form name="tuikuang" method="post" action="<?php echo U('Order/tuikuang_check');?>">
            ...
            <a class="button_a_lvse tijiao" >提交申请</a><a href='<?php echo U("Order/index");?>' class="quxiao">取消并返回</a>
        ...
        <div class="view_info">
            <?php if($order['deleted'] == '1'): ?><div>当前订单状态：<span class="red">该订单已被删除</span></div>
             <?php else: ?>   
                <div>当前订单状态：<span class="red"><?php echo order_status($order['pay_status'],$order['status'])['status'];?></span></div><?php endif; ?>
        </div>
        <div class="d2">
...
<script src="/Public/Home/Js/order_tuikuang.js" type="text/javascript"></script>
