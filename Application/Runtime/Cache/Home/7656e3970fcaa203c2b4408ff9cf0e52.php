...
<tr class="buy_table_head buy_table_content">
    <td colspan="5" class="yingfu">
        <label>
            付款方式：
            <select name="pay_method" >
                <?php if(is_array($pay_method)): $key = 0; $__LIST__ = $pay_method;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vopay): $mod = ($key % 2 );++$key;?><option value="<?php echo ($vopay["id"]); ?>" ><?php echo ($vopay["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
        </label>
    </td>
</tr>
    ...
    <a href="javascript:void(0)" class="a_tjdd" >去付款</a>
</div>
