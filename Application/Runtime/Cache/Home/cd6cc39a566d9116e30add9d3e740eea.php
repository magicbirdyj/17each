...
<script  type="text/javascript">
    ...
    <div class="release">
        ...
        <form name="sv_cont" method="post" action="<?php echo U('Member/release_goods');?>" >
            <div class="tr">
        ...
        <form name="release_goods" method="post" enctype="multipart/form-data" action="<?php echo U('Member/release_check');?>" onsubmit="editor.sync()">
            ...
            <div class="tr" style="<?php echo ($css); ?>">
                ...
                <div class="tr_td2">
                    <input name="radio_sex" type="radio" class="radio" value="0" checked="checked" />男
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input name="radio_sex" type="radio" class="radio" value="1" />女
                </div>
            </div><!--第二行-->
            ...
            <div class="tr">
                <div class="tr_td1">参加返现</div>
                    ...
                    <a href="<?php echo U('Company/index','name=fanxian');?>" id="fanxian_help" style="margin-left: 30px;border: 1px solid #888;padding:1px 5px;font-size: 12px;position: relative;bottom:2px;">查看详情</a>
            </div>
            <div style="width:400px;height:0px;border-top:1px dashed #666;"></div>
            <div class="tr">
