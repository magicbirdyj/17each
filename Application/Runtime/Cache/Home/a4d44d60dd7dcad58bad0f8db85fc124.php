...
<script  type="text/javascript">
    ...
    <div class="right">
        <div class="right_head">
            <div class="hlr_touxiang">
                <img src="<?php echo ($touxiang_url); ?>" class="img" id='touxiang_img' />
                <img src='/Public/Home/Images/public/circle_f6f6f6.png' class="img_circle" id='file_jia' style="cursor:pointer;" />
            </div>
 ...
 <form name="updated_head_queren" method="post"  action="<?php echo U('Member/updated_head_queren');?>">
