...
<div>密码修改:</div>
<ul>
<li><span class="zhuce_head_self">修改支付密码</span></li>
...
<div class="zhuce1_div_form">
    <form name="xiugaimima"  method="post" action="<?php echo U('Member/xiugai_zhifumima_success');?>" id="form1" >
...
<script src="/Public/Home/Js/xiugai_zhifumima.js" type="text/javascript"></script>
